...
public class AuthenticationBuilder {
    ...
    // 권한 객체를 발급하기 위한 여러가지 방식이 있는데, 기본적으로 로그인은 UsernamePasswordAuthenticationToken 을 발급하고 이걸로 Authentication 객체를 생성한다.

    public Authentication getAuthenticationForLogin(String customerId, String password){
        // SEQ 7 : UsernamePasswordAuthenticationToken 발급
        ...
        // SEQ 8 : UsernamePasswordAuthenticationToken 를 통해 Authentication 객체 생성 요청
        ...
        // 이어서 CustomerUserDetailService 에서 SEQ 9 확인

        // SEQ 10 : AuthenticationProvider 를 통해 생성된 User 클래스로 권한 생성 후 반환 된 상태.
